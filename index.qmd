...
:tophat: Currently working as AI Safety Tech Lead & Principal ML Engineer at Red Hat
:::
::::
...
:sparkling_heart: Our team is particularly interested in __safe__ and __reliable__ use of Generative AI with a focus on:
...
Training reduces unwanted outputs. It doesn't guarantee them. Moreover, you can be wasting lots of tokens by letting harmful inputs through
:::
...
![](img/qr-code-updated.png){fig-align="center" height=500}